            ...
            isConfiguring ? (
              ...
              <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg">
                <button disabled
                  ...
                  className="mb-4 px-4 py-2 bg-indigo-200 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  Configure QC Steps
                </button>
                <QCProcess />
